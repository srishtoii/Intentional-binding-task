...
expName = 'Intentional Binding test_exp'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\HP\\Desktop\\Ahmedabad University\\Lab In Psychology\\Intentional Binding test_exp_lastrun.py',
...
polygon_2 = visual.ShapeStim(
    ...
    size=(0.2, 0.2), vertices='circle',
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[0.3569, 1.0000, -0.6314], fillColor=[0.3569, 1.0000, -0.6314],
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('Intentional Binding test.xlsx'),
